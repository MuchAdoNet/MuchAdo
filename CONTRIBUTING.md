...
* Run `./build.ps1 coverage` to collect Coverlet coverage for all `net10.0` tests, including Docker-backed tests, and generate reports with `dotnet dnx dotnet-reportgenerator-globaltool` under `artifacts/Coverage/Report`.
